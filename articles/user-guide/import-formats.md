...
The opcode column is used to define the
...
are very similar. The primary difference is that
[*synthesis*](https://globalarchivemanual.github.io/GlobalArchive/articles/user-guide/glossary.html#synthesissyntheses)
metadata must include a
[*campaignid*](https://globalarchivemanual.github.io/GlobalArchive/articles/user-guide/glossary.html#campaignid)
column (Table 3). This is required because a
[*synthesis*](https://globalarchivemanual.github.io/GlobalArchive/articles/user-guide/glossary.html#synthesissyntheses)
may combine data from multiple
